...
<div class="dashboard-sidebar">
    ...
    <ul>
        <?php if ($_SESSION['role'] === 'student'): ?>
            ...
            <li><a href="/WebDevAsgn/student/view_projects.php">View Your Projects</a></li>
            ...
            <li><a href="/WebDevAsgn/meettheteam.php">Meet the Developers</a></li>
        ...
        <?php elseif ($_SESSION['role'] === 'supervisor'): ?>
            <li><a href="/WebDevAsgn/dashboard.php">Home</a></li>
            <li><a href="/WebDevAsgn/student/update_profile.php">Profile</a></li>
            <li><a href="/WebDevAsgn/supervisor/submit_proposal.php">Submit Proposal</a></li>
            <li><a href="/WebDevAsgn/supervisor/view_project.php">View Your Projects</a></li>
        ...
        <?php elseif ($_SESSION['role'] === 'admin'): ?>
            ...
            <li><a href="/WebDevAsgn/admin/update_proposal_status.php">Update Proposal Status</a></li>
